// Bundles win95-theme.css + win95-theme.js into win95-theme.json (the
// pasteable extension blob). If `w95fa.woff2` exists in the repo root
// it gets base64-inlined into the @font-face block; otherwise the
...
const jsPath = path.join(root, "win95-theme.js");
...
const js = toCRLF(fs.readFileSync(jsPath, "utf8"));
